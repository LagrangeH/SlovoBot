...
class BotUtils:
    ...
    def create_inline_kb(self, payload):
        ...
        if 'clear_diction' in payload:
            ...
            kb.add_button('04:00', color=VkKeyboardColor.PRIMARY, payload=['04:00'])
            kb.add_button('04:30', color=VkKeyboardColor.PRIMARY, payload=['04:30'])
            kb.add_button('05:00', color=VkKeyboardColor.PRIMARY, payload=['05:00'])
            kb.add_button('05:30', color=VkKeyboardColor.PRIMARY, payload=['05:30'])
            kb.add_line()
            kb.add_button('06:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('06:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('07:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('07:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_line()
            kb.add_button('08:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('08:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('09:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('09:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_line()
            kb.add_button('10:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('10:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('11:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('11:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_line()
            kb.add_button('12:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('12:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('13:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('13:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_line()
            kb.add_button('14:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('14:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('15:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('15:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_line()
            kb.add_button('16:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('16:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('17:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('17:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_line()
            kb.add_button('18:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('18:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('19:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('19:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_line()
            kb.add_button('20:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('20:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('21:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('21:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_line()
            kb.add_button('22:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('22:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('23:00', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
            kb.add_button('23:30', color=VkKeyboardColor.PRIMARY, payload=['3.30'])
        return kb.get_keyboard()
